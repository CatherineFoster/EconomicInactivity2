...
dta |> 
  ...
  theme_minimal() + 
  annotate("text", x = 0, y = 0, label = "O", fontface = "bold") + 
  annotate("text", x = 1, y = 0, label = "M", fontface = "bold") + 
  annotate("text", x = 0, y = 1, label = "P", fontface = "bold") + 
  annotate("text", x = 1, y = 1, label = "B", fontface = "bold") +
  geom_textcurve(
    data = data.frame(x = 0, y = 0, xend = 0, yend = 1), 
                      mapping = aes(x, y, xend = xend,  yend = yend), 
...
```{r}
#| label: tbl-hlth-continuous-6ool-diffs-saf
