...
We will also look at including measures of job quality in the above. 
We need to note that as the job quality measure only applies to persons in employment, the PICO frame will need to be adjusted accordingly; i.e this will look only at those who start off in employment, rather than the whole dataset. 
