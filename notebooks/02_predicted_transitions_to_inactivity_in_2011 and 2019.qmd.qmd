...
```
I've changed the reference category to single adult household (given, for example, these were the first groups UC was introduced to).
Compared with this reference category no groups appear statistically significantly different, at least once age and age squared are included. 
